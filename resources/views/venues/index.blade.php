    ...
    <div class="max-w-6xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            @forelse($venues as $venue)
                <div class="bg-white border border-gray-200 rounded-lg shadow p-6 hover:shadow-lg transition-shadow">
                    ...
                    <a href="{{ route('venues.show', $venue) }}" class="inline-block w-full text-center bg-blue-600 hover:bg-blue-700 text-black font-medium py-2 px-4 rounded transition-colors">
