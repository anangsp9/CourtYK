...
<body class="font-body-lg text-body-lg selection:bg-primary-fixed/30">
    <header
        ...
        <nav class="flex items-center justify-between px-gutter h-16 w-full max-w-7xl mx-auto">
            ...
            <div class="hidden md:flex items-center gap-8">
                <a class="text-on-surface-variant font-title-md text-title-md transition-colors" href="/">Home</a>
                <a class="text-primary-fixed font-title-md text-title-md hover:bg-white/5 transition-colors px-3 py-1 rounded"
    ...
    <main class="pt-24 pb-32 px-gutter min-h-screen max-w-7xl mx-auto">
        ...
        <!-- Wrapper utama -->
        <div class="md:sticky md:top-20 z-40 mb-10">
