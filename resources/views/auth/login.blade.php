                ...
                <div class="glass-card inner-glow rounded-lg p-6 md:p-8">
                    <div class="text-center mb-5">
                        <h1
                            ...
                            Welcome Back</h1>
                        <p class="text-on-surface/60 font-body-lg text-sm">Precision in every play starts here.</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('login') }}" class="space-y-3.5">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <span
                                    class="material-symbols-outlined absolute left-4 top-1/2 -translate-y-1/2 text-on-surface/40">lock</span>
                                <input
                                    class="input-glass bg-transparent w-full pl-12 pr-4 py-3 rounded-full text-primary placeholder:text-on-surface/30 focus:ring-0 focus:ring-offset-0"
                                    id="password" type="password" name="password" placeholder="••••••••" required
                                    autocomplete="current-password" />
                            </div>
                            <x-input-error :messages="$errors->get('password')" class="mt-1 text-xs text-red-400 px-2" />
                        </div>
                            ...
                            <label for="remember_me" class="flex items-center gap-2 cursor-pointer group">
                                <div class="relative flex items-center">
                                    <input id="remember_me" type="checkbox" name="remember"
                                        class="peer h-4 w-4 rounded bg-white/5 border-white/10 checked:bg-primary-fixed checked:border-primary-fixed focus:ring-offset-0 focus:ring-0 transition-all cursor-pointer" />
                                    <span
                                        class="material-symbols-outlined absolute inset-0 text-on-primary-fixed text-[12px] opacity-0 peer-checked:opacity-100 flex items-center justify-center pointer-events-none">check</span>
                                </div>
                                <span class="group-hover:text-primary transition-colors text-xs">Remember me</span>
                            </label>

                            @if (Route::has('password.request'))
                                <a class="hover:text-primary-fixed transition-colors text-xs"
                        ...
                        <button
                            class="w-full bg-primary-fixed text-on-primary-fixed font-title-md text-title-md py-3 rounded-full electric-glow"
                            type="submit">
                            Sign In
                        </button>
                    </form>
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <button
                            class="input-glass flex items-center justify-center gap-2 py-2.5 rounded-full hover:bg-white/10 transition-all font-label-sm text-label-sm text-xs">
